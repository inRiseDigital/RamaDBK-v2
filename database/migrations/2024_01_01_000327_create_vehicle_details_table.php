...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('vehicle_details', function (Blueprint $table) {
            ...
            $table->dateTime('gp_sent_date')->nullable();
