...
return new class extends Migration
{
    ...
    {
        Schema::create('order_invoice_tbl_new', function (Blueprint $table) {
            $table->integer('id');
            ...
            $table->boolean('status')->nullable()->default(0)->comment('0-pending 1-mature');
    ...
    {
        Schema::dropIfExists('order_invoice_tbl_new');
    }
};
