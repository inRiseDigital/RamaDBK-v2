...
return new class extends Migration
{
    ...
    {
        Schema::create('vehicle_details_04_09_2024', function (Blueprint $table) {
            ...
            $table->boolean('bl_sent_copy');
            $table->integer('good_value');
        });
    }
    ...
    {
        Schema::dropIfExists('vehicle_details_04_09_2024');
    }
};
