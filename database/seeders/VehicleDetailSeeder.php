    ...
    public function run(): void
    {
        ...
        DB::unprepared("
            CREATE TABLE vehicle_details (
                ...
                price_update_date VARCHAR(255) NOT NULL DEFAULT '',
                actual_price DOUBLE NOT NULL DEFAULT 0,
                commission DOUBLE NOT NULL DEFAULT 0,
                buying_price DOUBLE DEFAULT NULL,
                consumption_tax VARCHAR(255) DEFAULT NULL,
                ...
                grade_ext VARCHAR(255) DEFAULT '',
                grade_int VARCHAR(255) DEFAULT '',
                auction_grade VARCHAR(255) DEFAULT '',
                doors VARCHAR(255) DEFAULT NULL,
                seat_capacity VARCHAR(255) DEFAULT NULL,
                ...
                extend_date VARCHAR(255) NOT NULL DEFAULT '',
                ...
                int_color VARCHAR(255) DEFAULT NULL,
                ext_color VARCHAR(255) DEFAULT NULL,
                wd VARCHAR(255) DEFAULT '0',
                other_option TEXT DEFAULT NULL,
                start_date VARCHAR(255) DEFAULT NULL,
                close_date VARCHAR(255) NOT NULL DEFAULT '',
                data_source VARCHAR(255) DEFAULT NULL,
                confirm_time VARCHAR(255) DEFAULT NULL,
                data_sites VARCHAR(255) DEFAULT '',
                veh_title VARCHAR(255) DEFAULT '',
                accident INT DEFAULT 0,
                vin_number VARCHAR(255) DEFAULT '',
                ext_info_pos TEXT DEFAULT NULL,
                ext_info_pos_2 TEXT NOT NULL,
                ext_info_neg TEXT DEFAULT NULL,
                sellArea VARCHAR(255) DEFAULT '',
                is_tcv INT DEFAULT 0,
                export_area_id VARCHAR(255) DEFAULT '',
                dead_stock VARCHAR(255) NOT NULL DEFAULT '0',
                is_spare VARCHAR(255) NOT NULL DEFAULT '0',
                watch_list_status INT NOT NULL DEFAULT 0,
                market_price DOUBLE NOT NULL DEFAULT 0,
                market_price_date VARCHAR(255) NOT NULL DEFAULT '',
                customer_id INT NOT NULL DEFAULT 0,
                engine_type VARCHAR(255) NOT NULL DEFAULT '',
                ...
                videoFor VARCHAR(255) NOT NULL DEFAULT '',
                youtube_url VARCHAR(255) NOT NULL DEFAULT '',
                is_auction INT NOT NULL DEFAULT 2,
                auction_system VARCHAR(255) NOT NULL DEFAULT '',
                lot_no VARCHAR(255) NOT NULL DEFAULT '',
                hall_name VARCHAR(255) NOT NULL DEFAULT '',
                hall_location VARCHAR(255) NOT NULL DEFAULT '',
                input_date VARCHAR(255) NOT NULL DEFAULT '',
                ...
                purchased_by_value VARCHAR(255) NOT NULL DEFAULT '',
                requested_by_value VARCHAR(255) NOT NULL DEFAULT '',
                yard_id_value VARCHAR(255) NOT NULL DEFAULT '',
                is_completed INT NOT NULL DEFAULT 1,
                country VARCHAR(255) NOT NULL DEFAULT '',
                special_price DOUBLE NOT NULL DEFAULT 0,
                yard_date VARCHAR(255) NOT NULL DEFAULT '',
                transport_company_id INT NOT NULL DEFAULT 0,
                transport_company VARCHAR(255) NOT NULL DEFAULT '',
                remarks TEXT NOT NULL,
                auction VARCHAR(255) NOT NULL DEFAULT '',
                bid_number VARCHAR(255) NOT NULL DEFAULT '',
                auction_date VARCHAR(255) NOT NULL DEFAULT '',
                auc_import INT NOT NULL DEFAULT 0,
                img_copy INT NOT NULL DEFAULT 2,
                hit_counter INT NOT NULL DEFAULT 0,
                pics TEXT NOT NULL,
                auc_pics TEXT NOT NULL,
                enquiry_counter INT NOT NULL DEFAULT 0,
                customer_name VARCHAR(255) NOT NULL DEFAULT '',
                is_import INT NOT NULL DEFAULT 2,
                mail_sent INT NOT NULL DEFAULT 2,
                checked_date VARCHAR(255) NOT NULL DEFAULT '',
                yard_photo_count INT NOT NULL DEFAULT 0,
                uploaded_docs TEXT NOT NULL,
                ...
                transport_comment TEXT NOT NULL,
                re_auction INT NOT NULL DEFAULT 2,
                gp_mail_sent INT NOT NULL DEFAULT 2,
                gp_sent_date VARCHAR(255) NOT NULL DEFAULT '',
                ...
                ass_ids TEXT NOT NULL,
                ass_vals TEXT NOT NULL,
                d_stock_number VARCHAR(255) NOT NULL DEFAULT '',
                dealer_ref_no VARCHAR(255) NOT NULL DEFAULT '',
                d_stock_no INT NOT NULL DEFAULT 0,
                sync_as VARCHAR(255) NOT NULL DEFAULT '',
                ...
                date_of_entry VARCHAR(255) NOT NULL DEFAULT '',
                numbers_of_months_remaining INT NOT NULL DEFAULT 0,
                date_of_expiry VARCHAR(255) NOT NULL DEFAULT '',
                radiation_insu_no VARCHAR(255) NOT NULL DEFAULT '',
                radiation_insu_company VARCHAR(255) NOT NULL DEFAULT '',
                radiation_insu_reg_no VARCHAR(255) NOT NULL DEFAULT '',
                ...
                arai_img_check_date VARCHAR(255) NOT NULL DEFAULT '',
